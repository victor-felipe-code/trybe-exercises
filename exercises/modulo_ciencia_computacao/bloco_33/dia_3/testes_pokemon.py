...
# mocks: são pré programados para verificarem as
# chamadas das funções que receberem;

# stubs: proveem respostas predefinidas;

# spies: são como stubs, mas também
# armazenam informações de como foram chamados.
